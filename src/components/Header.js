          ...
          <>
               <header className='header-top-strip py-2'>
                    <div className='container'>
                         <div className='row'>
                              <div className='col-6'>
                                   <p className='text-white mb-0'>FreeShip Over $100 & Free Returns</p>
                              </div>
                              <div className='col-6'>
                                   <p className='text-end text-white mb-0'>
                                        Hotline:
                                        <a className='text-white' href='tel: +84 392911926'>
                                             +84 39291126
                                        </a>
                                   </p>
                              </div>
                                   ...
                                   <div className='menu-bottom d-flex align-items-center gap-30'>
                                        <div>
                                             <div className='dropdown'>
                                                  <button
                                                       className='btn btn-secondary bg-transparent dropdown-toggle border-0 gap-2 d-flex align-items-center'
                                                       type='button'
